...
var UserModel = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        throw new Error("Unable to show users, ".concat(error_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_2 = _a.sent();
                        throw new Error("Unable to show user with id ".concat(id, ", ").concat(error_2));
                    case 3: return [2 /*return*/];
                }
            });
        });
    ...
    UserModel.prototype.create = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var passwordHashedUserObj, oldUser, result, newUser, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        passwordHashedUserObj = {
                    ...
                    case 1:
                        _a.trys.push([1, 5, , 6]);
                        return [4 /*yield*/, db.collection('users').findOne({ email: user.email.toLowerCase() })];
                    case 2:
                        oldUser = _a.sent();
                        if (oldUser) {
                        ...
                        return [4 /*yield*/, db
                                .collection('users')
                                .insertOne(passwordHashedUserObj)];
                    case 3:
                        result = (_a.sent());
                        return [4 /*yield*/, db
                                .collection('users')
                                .find({ _id: new mongodb_1.ObjectId(result.insertedId) })
                                .project({ password: 0 })
                                .toArray()];
                    case 4:
                        newUser = (_a.sent())[0];
                    ...
                    case 5:
                        error_3 = _a.sent();
                        throw new Error("Unable to create user, ".concat(error_3));
    ...
    UserModel.prototype.update = function (user, id) {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_4 = _a.sent();
                        throw new Error("Unable to update user with id ".concat(id, ", ").concat(error_4));
                    case 3: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_5 = _a.sent();
                        throw new Error("Unable to delete user with id ".concat(id, ", ").concat(error_5));
                    case 3: return [2 /*return*/];
                }
            });
        });
    ...
    UserModel.prototype.checkUserEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, db.collection('users').find({ email: email }).project({ password: 0 }).toArray()];
                    case 1:
                        result = (_a.sent())[0];
                        return [2 /*return*/, result];
                    case 2:
                        error_6 = _a.sent();
                        throw new Error("Could not check user email ".concat(email, " ").concat(error_6));
                    case 3: return [2 /*return*/];
                }
            });
        });
