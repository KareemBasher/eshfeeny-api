...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productObj, product, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                productObj = {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, productModel.create(productObj)];
            case 2:
                product = _a.sent();
                res.json(product);
                return [3 /*break*/, 4];
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productObj, product, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                productObj = {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, productModel.update(productObj, req.params.id)];
            case 2:
                product = _a.sent();
                res.json(product);
                return [3 /*break*/, 4];
...
var getMany = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var ids, products, error_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ids = req.params.ids.split('&');
                return [4 /*yield*/, productModel.getMany(ids)];
            case 1:
                products = _a.sent();
                res.json(products);
                return [3 /*break*/, 3];
