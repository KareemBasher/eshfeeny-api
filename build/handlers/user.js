...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, userModel.create(userObj)];
            case 2:
                user = _a.sent();
                res.json(user);
                return [3 /*break*/, 4];
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, userModel.update(userObj, req.params.id)];
            case 2:
                user = _a.sent();
                res.json(user);
                return [3 /*break*/, 4];
...
var checkUserEmail = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, error_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, userModel.checkUserEmail(req.body.email)];
            case 1:
                user = _a.sent();
                if (!user)
                    res.send(false);
